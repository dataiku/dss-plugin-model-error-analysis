...
class KneeLocator(object):
    ...
    def __init__(
        ...
        S = 1.0, # float = 1.0
        curve = "concave", # str
        direction = "increasing", # str = "increasing"
        interp_method = "interp1d", # str = "interp1d"
        online = False, # bool = False
        polynomial_degree = 7 # int = 7
    ):
        """
        :ivar x: x values.
    ...
    def __normalize(a):
        """normalize an array
        :Iterable[float] a: The array to normalize 
        Returns:
            `Iterable[float]`
        """
    ...
    def transform_y(y, direction, curve):
        ...
        :Iterable[float] y: The array to transform
        :str direction: direction to transform
        :str curve: curve to transform
        Returns:
            `float`
        """
