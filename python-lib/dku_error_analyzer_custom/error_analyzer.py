...
from dku_error_analyzer_custom.knee_locator import get_epsilon
...
class ErrorAnalyzer(BaseEstimator):
    ...
    def fit(self, X, y):
        ...
        logger.info("error_rate {} {}".format(error_rate, ErrorAnalyzerConstants.MIN_SAMPLES_LEAF_LOWEST_UPPER_BOUND))
